...
const correctedInvoices = [
  { invoiceId: 'inv:0-ChDR7q-F0W8c3_001d90c12cEJ8I', invoiceNumber: '4320', purchaserEmail: 'omar.armenta@psjaisd.us', schoolName: 'DR WILLIAM LONG EL', players: [ { name: 'Ivan Ramirez', uscfId: '30298479' }, { name: 'Skylar Mendiola', uscfId: '30769940' }, { name: 'Kenzie Aviles', uscfId: '31488558' }, { name: 'Gabriella Rendon', uscfId: '31488628' }, { name: 'Ruben Salinas', uscfId: '31488644' }, { name: 'AnnaBelle Tagle', uscfId: '31488924' }, { name: 'Jorge Cantu', uscfId: 'NEW' }, { name: 'Melinna Zuniga', uscfId: 'NEW' }, { name: 'Luke Castro', uscfId: 'NEW' } ], uscfRenewals: ['Jorge Cantu', 'Melinna Zuniga', 'Luke Castro'] },
  { invoiceId: 'inv:0-ChA-some_unique_id_for_4318', invoiceNumber: '4318', purchaserEmail: 'maria.sinapuelas@psjaisd.us', schoolName: 'GRACIELA GARCIA EL', players: [ { name: 'Natalie Lopez', uscfId: '32256928' }, { name: 'Joshua Martinez', uscfId: '30367625' } ], uscfRenewals: [] },
  { invoiceId: 'inv:0-ChA-some_unique_id_for_4317', invoiceNumber: '4317', purchaserEmail: 'hernan.cortez@psjaisd.us', schoolName: 'KENNEDY MIDDLE', players: [ { name: 'Airam Ramirez-Loredo', uscfId: '32157156' } ], uscfRenewals: [] },
  { invoiceId: 'inv:0-ChAV3g-9g0a9FX8D-m77z3-wEJ8I', invoiceNumber: '4315', purchaserEmail: 'guadalupe.elizondo2@psjaisd.us', schoolName: 'GERALDINE PALMER EL', players: [ { name: 'Matias Chavez', uscfId: '32052592' } ], uscfRenewals: [] },
  { invoiceId: 'inv:0-ChBvHo9HhSLsFXoFmT96z3-wEJ8I', invoiceNumber: '4314', purchaserEmail: 'ashley.rodriguez@psjaisd.us', schoolName: 'PSJA COLLEGIATE SCHOOL OF HEALTH PROFESSIONS', players: [ { name: 'Esteban Garza JR', uscfId: '15863055' }, { name: 'Kate Fernandez', uscfId: '16801086' }, { name: 'Raul Gonzalez III', uscfId: '30299472' }, { name: 'Orlando Delgado Garcia', uscfId: '30309132' }, { name: 'Jorge Cantu Alvarez', uscfId: '31488082' }, { name: 'Diego Bocanegra Amaro', uscfId: '31499254' }, { name: 'Azul Cuevas Elizalde', uscfId: '32046484' } ], uscfRenewals: [] },
  { invoiceId: 'inv:0-ChBqF8jY6Yf2Kk8YxH4-mJj0EJ8I', invoiceNumber: '4313', purchaserEmail: 'kanie.deleon@psjaisd.us', schoolName: 'AUSTIN MIDDLE', players: [ { name: 'Cianni Vargas', uscfId: '16800831' }, { name: 'Emiliano Medina', uscfId: '30298794' }, { name: 'Carlos De Leon JR', uscfId: '30347260' }, { name: 'Fatima Garza', uscfId: '30347282' }, { name: 'Damian Cuellar', uscfId: '31487695' }, { name: 'Enzo Cervantes', uscfId: '31487845' }, { name: 'Heriberto Garza JR', uscfId: '32114974' }, { name: 'Matthew Gonzalez', uscfId: 'NEW' }, { name: 'Dallas Evans', uscfId: 'NEW' }, { name: 'Ezra Rivera', uscfId: 'NEW' } ], uscfRenewals: [ 'Cianni Vargas', 'Emiliano Medina', 'Carlos De Leon JR', 'Fatima Garza', 'Matthew Gonzalez', 'Dallas Evans', 'Ezra Rivera' ] },
  { invoiceId: 'inv:0-ChAn7iUtCfPpjCRGA9NEEaE9EJ8I', invoiceNumber: '4312', purchaserEmail: 'hernan.cortez@psjaisd.us', schoolName: 'KENNEDY MIDDLE', players: [ { name: 'Luis Cortez', uscfId: '30271062' }, { name: 'Rodrigo Izaguirre', uscfId: '30728191' }, { name: 'Jesus Cordero', uscfId: '31489716' }, { name: 'Jayden Jimenez', uscfId: '31489894' }, { name: 'Raul Pedraza Jr.', uscfId: '31489934' }, { name: 'Ruben Elizondo', uscfId: '32115166' }, { name: 'Norberto Gonzalez', uscfId: '32115265' }, { name: 'Ruben Paez', uscfId: '32115492' }, { name: 'Aurik Romo', uscfId: 'NEW' }, { name: 'Jocelyn Snow', uscfId: 'NEW' } ], uscfRenewals: ['Rodrigo Izaguirre', 'Aurik Romo', 'Jocelyn Snow'] },
  { invoiceId: 'inv:0-ChBdDmnPzwd4w1bnyDo6_TiqEJ8I', invoiceNumber: '4311', purchaserEmail: 'corina.perez@psjaisd.us', schoolName: 'ALFRED SORENSEN EL', players: [ { name: 'Arianna Cantu', uscfId: '32063642' }, { name: 'Austin Salinas', uscfId: '32063726' }, { name: 'Jace Sandoval', uscfId: '32063733' }, { name: 'Adrian Villa', uscfId: '32063759' }, { name: 'Hiram Flores', uscfId: '32064001' }, { name: 'Landen Valerio', uscfId: '32115736' }, { name: 'Saori Tamez', uscfId: '32115752' }, { name: 'Matthew De La Cruz', uscfId: '32156812' }, { name: 'Amirah Jalili', uscfId: '32156857' }, { name: 'Shenell Vaca', uscfId: '32156866' }, { name: 'Silas De La Garza', uscfId: '32157003' } ], uscfRenewals: [] },
  { invoiceId: 'inv:0-ChBNQswPcqy73RC1UKsvtOzjEJ8I', invoiceNumber: '4310', purchaserEmail: 'vivian.barbosa@psjaisd.us', schoolName: 'JOHN MCKEEVER EL', players: [ { name: 'Ethan Gonzalez', uscfId: '30308816' }, { name: 'Ezra Gonzalez', uscfId: '30764897' }, { name: 'Noah Vives', uscfId: '31491001' }, { name: 'Abel Garza', uscfId: 'NEW' }, { name: 'Lizeth De Leon', uscfId: 'NEW' }, { name: 'Alayna Calderon', uscfId: 'NEW' }, { name: 'Gael Torres', uscfId: 'NEW' }, { name: 'Noe Garza', uscfId: 'NEW' }, { name: 'Rocco Sloss', uscfId: 'NEW' }, { name: 'Vanessa Lopez', uscfId: 'NEW' }, { name: 'Lucia Gonzalez', uscfId: 'NEW' }, { name: 'Josue Contreras', uscfId: 'NEW' } ], uscfRenewals: ['Alayna Calderon', 'Gael Torres', 'Noe Garza', 'Rocco Sloss', 'Vanessa Lopez', 'Lucia Gonzalez', 'Josue Contreras'] },
  { invoiceId: 'inv:0-ChAYQ6qf_K_z_X0-y_LqjG5dEJ8I', invoiceNumber: '4309', purchaserEmail: 'hernan.cortez@psjaisd.us', schoolName: 'KENNEDY MIDDLE', players: [ { name: 'Bianca Betancourt', uscfId: '31489679' } ], uscfRenewals: [] },
  { invoiceId: 'inv:0-ChBHdh1QYkO8HnPidl0QmuWvEJ8I', invoiceNumber: '4306', purchaserEmail: 'guadalupe.elizondo2@psjaisd.us', schoolName: 'GERALDINE PALMER EL', players: [ { name: 'Matthew Trevino', uscfId: '32042450' }, { name: 'Liam Salinas', uscfId: 'New' } ], uscfRenewals: ['Liam Salinas'] },
  { invoiceId: 'inv:0-ChCWUBF_yvdJJNj1hxBeOQwjEJ8I', invoiceNumber: '4305', purchaserEmail: 'guadalupe.elizondo2@psjaisd.us', schoolName: 'GERALDINE PALMER EL', players: [ { name: 'Sofia Lee Reyes', uscfId: '30874987' }, { name: 'Michael Trevino', uscfId: '32052426' }, { name: 'Devin Garcia', uscfId: '32115565' }, { name: 'Leonardo Martinez', uscfId: '32115583' }, { name: 'lauren Sauceda', uscfId: '32115634' }, { name: 'Briana Garcia', uscfId: '32115648' }, { name: 'Mateo Soto', uscfId: 'New' } ], uscfRenewals: ['Mateo Soto'] },
  { invoiceId: 'inv:0-ChCmSldsxygecLHLDtuGWraXEJ8I', invoiceNumber: '4304', purchaserEmail: 'yeimi.garcia@psjaisd.us', schoolName: 'DR WILLIAM LONG EL', players: [ { name: 'Austin Zepeda', uscfId: '31498736' }, { name: 'Kaillou Cardenas', uscfId: '32052839' }, { name: 'Neva Quintana', uscfId: '32052866' }, { name: 'Henry Teyer', uscfId: '32052881' }, { name: 'Mia Monrreal', uscfId: 'NEW' }, { name: 'Diego Cortes', uscfId: 'NEW' }, { name: 'Ryan Garcia', uscfId: 'NEW' }, { name: 'Liam Madrigal', uscfId: 'NEW' } ], uscfRenewals: ['Mia Monrreal', 'Diego Cortes', 'Ryan Garcia', 'Liam Madrigal'] },
  { invoiceId: 'inv:0-ChBaPl56VbrMq6-fQWViXjt_EJ8I', invoiceNumber: '4303', purchaserEmail: 'sebastian.tijerina@psjaisd.us', schoolName: 'AIDA C ESCOBAR EL', players: [ { name: 'Sebastian Garcia', uscfId: 'NEW' }, { name: 'Landon Garza', uscfId: '31489035' }, { name: 'Jonathan Landero', uscfId: '31489051' }, { name: 'Claudio Ovalle', uscfId: '31489062' }, { name: 'Luciana Torres', uscfId: '31489095' }, { name: 'Roy Gonzalez', uscfId: '31499271' }, { name: 'Emari Salinas', uscfId: 'NEW' }, { name: 'Daniel Diaz', uscfId: 'NEW' }, { name: 'Jaxson Tate', uscfId: 'NEW' }, { name: 'Lilian Cruz', uscfId: 'NEW' }, { name: 'Jayden Luther', uscfId: 'NEW' }, { name: 'Camila Espinoza', uscfId: 'NEW' }, { name: 'Jonathon Monroy', uscfId: 'NEW' }, { name: 'Matias Izaguirre', uscfId: 'NEW' }, { name: 'Luna Rodeiguez', uscfId: 'NEW' }, { name: 'Erik Martinez', uscfId: 'NEW' }, { name: 'Landon Arriaga', uscfId: 'NEW' }, { name: 'Gabriela Vazquez', uscfId: 'NEW' }, { name: 'Ian Madera', uscfId: 'NEW' }, { name: 'Iker Cruz', uscfId: 'NEW' } ], uscfRenewals: ['Sebastian Garcia', 'Landon Garza', 'Jonathan Landero', 'Claudio Ovalle', 'Luciana Torres', 'Roy Gonzalez', 'Emari Salinas', 'Daniel Diaz', 'Jaxson Tate', 'Lilian Cruz', 'Jayden Luther', 'Camila Espinoza', 'Jonathon Monroy', 'Matias Izaguirre', 'Luna Rodeiguez', 'Erik Martinez', 'Landon Arriaga', 'Gabriela Vazquez', 'Ian Madera', 'Iker Cruz'] },
  { invoiceId: 'inv:0-ChDxVsUuK-JVya_ZzZUpon1gEJ8I', invoiceNumber: '4301', purchaserEmail: 'rene.trevino@psjaisd.us', schoolName: 'GRACIELA GARCIA EL', players: [ { name: 'Joshua Martinez', uscfId: '30367625' }, { name: 'Juan Espinoza', uscfId: '32115099' }, { name: 'Noel Saucedo Ravise', uscfId: '32115102' }, { name: 'Jorge Guillen', uscfId: '32115113' }, { name: 'Aldo De Luna', uscfId: '32115122' }, { name: 'Olivia Garza', uscfId: '32115130' }, { name: 'Jose Gonzalez', uscfId: '32115141' }, { name: 'Olivia Garcia', uscfId: '32115151' }, { name: 'Sebastian Mena', uscfId: '32115194' }, { name: 'Ramses De Luna', uscfId: '32195946' }, { name: 'Alice Betancourt', uscfId: '32256481' }, { name: 'Natalie Lopez', uscfId: '32256928' }, { name: 'Scarlett Perez', uscfId: '321115089' }, { name: 'Zoe Martinez', uscfId: 'new' }, { name: 'Janell Cruz', uscfId: 'new' }, { name: 'Karim Vasquez', uscfId: 'new' }, { name: 'Brianna Ramirez', uscfId: 'NEW' }, { name: 'Javier Lopez', uscfId: 'NEW' }, {_player: "Maximiliano Gonzalez", uscfId: "NEW" }, {_player: "Michael Gonza", uscfId: "NEW" } ], uscfRenewals: ['Zoe Martinez', 'Janell Cruz', 'Karim Vasquez', 'Brianna Ramirez', 'Javier Lopez', 'Maximiliano Gonzalez', 'Michael Gonza'] },
  { invoiceId: 'inv:0-ChBMhCueCIThav0cbt_OhdfvEJ8I', invoiceNumber: '4300', purchaserEmail: 'alonzo.hernandez@psjaisd.us', schoolName: 'AUDIE MURPHY MIDDLE', players: [ { name: 'Luciano Flores', uscfId: '3209070' }, { name: 'ricardo vela', uscfId: '30298695' }, { name: 'Devin Flores', uscfId: '30858424' }, { name: 'Anthony Sanchez', uscfId: '31489306' }, { name: 'Jake Lopez', uscfId: '31489536' }, { name: 'Eli Ramos', uscfId: '31679022' }, { name: 'Jose Nicanor', uscfId: '32115244' }, { name: 'Joaquin Rodriguez', uscfId: 'New' }, { name: 'Amen Torres', uscfId: 'New' } ], uscfRenewals: ['Devin Flores', 'Eli Ramos', 'Joaquin Rodriguez', 'Amen Torres'] },
  { invoiceId: 'inv:0-DQLHUvzOpAoD3bsGx7FqR9EJ8I', invoiceNumber: '4299', purchaserEmail: 'rafael.rodriguez@psjaisd.us', schoolName: 'AUSTIN MIDDLE', players: [ { name: 'Edward Trevino', uscfId: '16469688' }, { name: 'Benjamin Carpio', uscfId: '16800852' }, { name: 'LIam Chapa', uscfId: '30347273' }, { name: 'Derek Tarango', uscfId: '30769889' }, { name: 'Hezekiah Perez', uscfId: '31497168' }, { name: 'Liam Perez', uscfId: '32063717' }, { name: 'Josiah Hernandez', uscfId: '32114967' }, { name: 'Autumn Garza', uscfId: '32115788' }, { name: 'Luke Nava', uscfId: 'New' } ], uscfRenewals: ['Hezekiah Perez', 'Luke Nava'] },
  { invoiceId: 'inv:0-ChAx46Cd3v8CDBwV5WipTYoxEJ8I', invoiceNumber: '4298', purchaserEmail: 'oscar.quintanilla@psjaisd.us', schoolName: 'AMANDA GARZA-PENA EL', players: [ { name: 'Athena Munoz', uscfId: '122025' }, { name: 'Ricardo Castillo', uscfId: '3148913' }, { name: 'Cesario Aranda', uscfId: '31489122' }, { name: 'Javier Montes', uscfId: '31489160' }, { name: 'Jax Leal', uscfId: '31489171' }, { name: 'Daniel Tevino', uscfId: '32042219' }, { name: 'Zendrix Oviedo', uscfId: '32049200' }, { name: 'Flavia Tavera', uscfId: 'New' }, { name: 'Alijah Vega', uscfId: 'New' }, { name: 'Jermaine Guzman', uscfId: 'New' } ], uscfRenewals: ['Flavia Tavera', 'Alijah Vega', 'Jermaine Guzman'] },
  { invoiceId: 'inv:0-ChBNzNLwVIafEnQHyBW6urc6EJ8I', invoiceNumber: '4297', purchaserEmail: 'moises.diaz@psjaisd.us', schoolName: 'PSJA THOMAS JEFFERSON T-STEM EARLY COLLEGE H S', players: [ { name: 'Carlos Martinez', uscfId: '16112301' }, { name: 'Aiden Cantu', uscfId: '16112426' }, { name: 'Alan Alaniz', uscfId: '16473088' }, { name: 'Kaleb Martinez', uscfId: '17207981' }, { name: 'Rogelio Martinez', uscfId: '31490089' }, { name: 'Jose Cavazos', uscfId: '31499413' }, { name: 'Reynaldo Carranza', uscfId: '31499459' }, { name: 'Alexa Martinez - Valdvia', uscfId: '31606813' }, { name: 'Timothy Perez', uscfId: '32046572' }, { name: 'Esmeralda Torres', uscfId: '32115836' }, { name: 'Aliyah Cantu', uscfId: '32115845' }, { name: 'Dwayne Lozano', uscfId: '158652994' }, { name: 'Noah Hinojosa', uscfId: 'NEW' } ], uscfRenewals: ['Reynaldo Carranza', 'Alexa Martinez - Valdvia', 'Noah Hinojosa'] },
  { invoiceId: 'inv:0-ChAZegmuSRaJb6UkJ3umHdvnEJ8I', invoiceNumber: '4294', purchaserEmail: 'juan.lopez1@psjaisd.us', schoolName: 'ARNOLDO CANTU SR EL', players: [ { name: 'Kalee Hernandez', uscfId: '31487795' }, { name: 'Emma Morales', uscfId: '32114990' }, { name: 'Andrea Munoz', uscfId: '32157067' }, { name: 'Ezra Ruiz', uscfId: '32157070' }, { name: 'Manuel Garcia', uscfId: '32256496' }, { name: 'Madelynn Garza', uscfId: '32256631' }, { name: 'Mikayla Anzaldua', uscfId: 'NEW' }, { name: 'Francisco Morales', uscfId: 'NEW' }, { name: 'Emily Requenez', uscfId: 'NEW' }, { name: 'Emmanuel Barrera', uscfId: 'NEW' } ], uscfRenewals: ['Mikayla Anzaldua', 'Francisco Morales', 'Emily Requenez', 'Emmanuel Barrera'] },
  { invoiceId: 'inv:0-ChBuPdz9VuWBFSlozSR4g8JwEJ8I', invoiceNumber: '4296', purchaserEmail: 'juan.lopez1@psjaisd.us', schoolName: 'ARNOLDO CANTU SR EL', players: [ { name: 'Lucas Arevalo', uscfId: '32052478' } ], uscfRenewals: ['Lucas Arevalo'] },
  { invoiceId: 'inv:0-ChD24e3_fX-c2Hl-sV9g3G8dEJ8I', invoiceNumber: '4293', purchaserEmail: 'juan.lopez1@psjaisd.us', schoolName: 'ARNOLDO CANTU SR EL', players: [ { name: 'Sophia Rangel', uscfId: '30308734' }, { name: 'Natalie Garcia', uscfId: '30764837' }, { name: 'Giancarlo Garcia', uscfId: '32052515' }, { name: 'Ryan Moreno', uscfId: '32052572' }, { name: 'Giovanni Garcia', uscfId: '32195702' }, { name: 'Michael Alaniz', uscfId: '30728261' }, { name: 'Joshua Flores', uscfId: 'NEW' }, { name: 'Dariel Gonzalez', uscfId: 'NEW' }, { name: 'Romeo Cano', uscfId: 'NEW' }, { name: 'Jayde Valle', uscfId: 'NEW' }, { name: 'Jadiel Garcia', uscfId: 'NEW' } ], uscfRenewals: ['Sophia Rangel', 'Natalie Garcia', 'Giancarlo Garcia', 'Ryan Moreno', 'Giovanni Garcia', 'Michael Alaniz', 'Joshua Flores', 'Dariel Gonzalez', 'Romeo Cano', 'Jayde Valle', 'Jadiel Garcia'] },
];
...
export default function ManualInvoiceUpdatePage() {
  ...
  useEffect(() => {
    const runUpdate = async () => {
      ...
      addLog(`--- Starting PSJA Invoice Data Migration for ${correctedInvoices.length} Invoices ---`);
      ...
      for (const inv of correctedInvoices) {
        try {
            ...
            for (const p of inv.players) {
                // Handle the case where player data is malformed
                const playerName = (p as any).name || (p as any)._player;
                if (!playerName) {
                    addLog(`[WARN] Invoice #${inv.invoiceNumber}: Skipping player with missing name.`, true);
                    continue;
                }

                const playerId = generatePlayerId(p.uscfId, playerName);
                const isUscfNeeded = inv.uscfRenewals.includes(playerName);
                const isGt = gtPlayerUscfIds.has(p.uscfId) || gtPlayersByNameAndSchool.has(`${playerName}-${sponsor.school}`);
            ...
            const invoiceRecord = {
                ...
                schoolName: inv.schoolName || sponsor.school,
