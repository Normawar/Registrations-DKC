...
const correctedInvoices = [
  ...
  { invoiceId: 'inv:0-ChBqF8jY6Yf2Kk8YxH4-mJj0EJ8I', invoiceNumber: '4313', purchaserName: 'Kanie De Leon', purchaserEmail: 'kanie.deleon@psjaisd.us', players: [ { name: 'Cianni Vargas', uscfId: '16800831' }, { name: 'Emiliano Medina', uscfId: '30298794' }, { name: 'Carlos De Leon JR', uscfId: '30347260' }, { name: 'Fatima Garza', uscfId: '30347282' }, { name: 'Damian Cuellar', uscfId: '31487695' }, { name: 'Enzo Cervantes', uscfId: '31487845' }, { name: 'Heriberto Garza JR', uscfId: '32114974' }, { name: 'Matthew Gonzalez', uscfId: 'NEW' }, { name: 'Dallas Evans', uscfId: 'NEW' }, { name: 'Ezra Rivera', uscfId: 'NEW' } ], uscfRenewals: [ 'Cianni Vargas', 'Emiliano Medina', 'Carlos De Leon JR', 'Fatima Garza', 'Matthew Gonzalez', 'Dallas Evans', 'Ezra Rivera' ] },
  ...
  { invoiceId: 'inv:0-ChBHdh1QYkO8HnPidl0QmuWvEJ8I', invoiceNumber: '4306', purchaserName: 'Guadalupe Elizondo', purchaserEmail: 'guadalupe.elizondo2@psjaisd.us', players: [ { name: 'Matthew Trevino', uscfId: '32042450' }, { name: 'Liam Salinas', uscfId: 'New' } ], uscfRenewals: ['Liam Salinas'] },
  { invoiceId: 'inv:0-ChCmSldsxygecLHLDtuGWraXEJ8I', invoiceNumber: '4304', purchaserName: 'Yeimi Garcia', purchaserEmail: 'yeimi.garcia@psjaisd.us', players: [ { name: 'Austin Zepeda', uscfId: '31498736' }, { name: 'Kaillou Cardenas', uscfId: '32052839' }, { name: 'Neva Quintana', uscfId: '32052866' }, { name: 'Henry Teyer', uscfId: '32052881' }, { name: 'Mia Monrreal', uscfId: 'NEW' }, { name: 'Diego Cortes', uscfId: 'NEW' }, { name: 'Ryan Garcia', uscfId: 'NEW' }, { name: 'Liam Madrigal', uscfId: 'NEW' } ], uscfRenewals: ['Mia Monrreal', 'Diego Cortes', 'Ryan Garcia', 'Liam Madrigal'] },
  { invoiceId: 'inv:0-ChCWUBF_yvdJJNj1hxBeOQwjEJ8I', invoiceNumber: '4305', purchaserName: 'Guadalupe Elizondo', purchaserEmail: 'guadalupe.elizondo2@psjaisd.us', players: [ { name: 'Sofia Lee Reyes', uscfId: '30874987' }, { name: 'Michael Trevino', uscfId: '32052426' }, { name: 'Devin Garcia', uscfId: '32115565' }, { name: 'Leonardo Martinez', uscfId: '32115583' }, { name: 'lauren Sauceda', uscfId: '32115634' }, { name: 'Briana Garcia', uscfId: '32115648' }, { name: 'Mateo Soto', uscfId: 'New' } ], uscfRenewals: ['Mateo Soto'] },
  { invoiceId: 'inv:0-ChBaPl56VbrMq6-fQWViXjt_EJ8I', invoiceNumber: '4303', purchaserName: 'Sebastian Tijerina', purchaserEmail: 'sebastian.tijerina@psjaisd.us', players: [ { name: 'Sebastian Garcia', uscfId: 'NEW' }, { name: 'Landon Garza', uscfId: '31489035' }, { name: 'Jonathan Landero', uscfId: '31489051' }, { name: 'Claudio Ovalle', uscfId: '31489062' }, { name: 'Luciana Torres', uscfId: '31489095' }, { name: 'Roy Gonzalez', uscfId: '31499271' }, { name: 'Emari Salinas', uscfId: 'NEW' }, { name: 'Daniel Diaz', uscfId: 'NEW' }, { name: 'Jaxson Tate', uscfId: 'NEW' }, { name: 'Lilian Cruz', uscfId: 'NEW' }, { name: 'Jayden Luther', uscfId: 'NEW' }, { name: 'Camila Espinoza', uscfId: 'NEW' }, { name: 'Jonathon Monroy', uscfId: 'NEW' }, { name: 'Matias Izaguirre', uscfId: 'NEW' }, { name: 'Matias Izaguirre', uscfId: 'NEW' }, { name: 'Luna Rodeiguez', uscfId: 'NEW' }, { name: 'Erik Martinez', uscfId: 'NEW' }, { name: 'Landon Arriaga', uscfId: 'NEW' }, { name: 'Gabriela Vazquez', uscfId: 'NEW' }, { name: 'Ian Madera', uscfId: 'NEW' }, { name: 'Iker Cruz', uscfId: 'NEW' } ], uscfRenewals: ['Sebastian Garcia', 'Landon Garza', 'Jonathan Landero', 'Claudio Ovalle', 'Luciana Torres', 'Roy Gonzalez', 'Emari Salinas', 'Daniel Diaz', 'Jaxson Tate', 'Lilian Cruz', 'Jayden Luther', 'Camila Espinoza', 'Jonathon Monroy', 'Matias Izaguirre', 'Matias Izaguirre', 'Luna Rodeiguez', 'Erik Martinez', 'Landon Arriaga', 'Gabriela Vazquez', 'Ian Madera', 'Iker Cruz'] },
  { invoiceId: 'inv:0-ChAFLjzZWmImp8hjFZN77oS-EJ8I', invoiceNumber: '4302', purchaserName: 'Guadalupe Elizondo', purchaserEmail: 'guadalupe.elizondo2@psjaisd.us', players: [ { name: 'Matthew Trevino', uscfId: 'New' }, { name: 'Liam Salinas', uscfId: 'New' }, { name: 'Briana Garcia', uscfId: 'New' }, { name: 'Devin Garcia', uscfId: 'New' }, { name: 'Mateo Soto', uscfId: 'New' }, { name: 'Sofia Lee Reyes', uscfId: 'New' }, { name: 'Leonardo Martinez', uscfId: 'New' }, { name: 'Michael Trevino', uscfId: 'New' } ], uscfRenewals: ['Matthew Trevino', 'Liam Salinas', 'Briana Garcia', 'Devin Garcia', 'Mateo Soto', 'Sofia Lee Reyes', 'Leonardo Martinez', 'Michael Trevino'] },
  { invoiceId: 'inv:0-ChDxVsUuK-JVya_ZzZUpon1gEJ8I', invoiceNumber: '4301', purchaserName: 'Rene Trevino', purchaserEmail: 'rene.trevino@psjaisd.us', players: [ { name: 'Joshua Martinez', uscfId: '30367625' }, { name: 'Juan Espinoza', uscfId: '32115099' }, { name: 'Noel Saucedo Ravise', uscfId: '32115102' }, { name: 'Jorge Guillen', uscfId: '32115113' }, { name: 'Aldo De Luna', uscfId: '32115122' }, { name: 'Olivia Garza', uscfId: '32115130' }, { name: 'Jose Gonzalez', uscfId: '32115141' }, { name: 'Olivia Garcia', uscfId: '32115151' }, { name: 'Sebastian Mena', uscfId: '32115194' }, { name: 'Ramses De Luna', uscfId: '32195946' }, { name: 'Alice Betancourt', uscfId: '32256481' }, { name: 'Natalie Lopez', uscfId: '32256928' }, { name: 'Scarlett Perez', uscfId: '321115089' }, { name: 'Zoe Martinez', uscfId: 'new' }, { name: 'Janell Cruz', uscfId: 'new' }, { name: 'Karim Vasquez', uscfId: 'new' }, { name: 'Brianna Ramirez', uscfId: 'NEW' }, { name: 'Javier Lopez', uscfId: 'NEW' }, { name: 'Maximiliano Gonzalez', uscfId: 'NEW' }, { name: 'Michael Gonza', uscfId: 'NEW' } ], uscfRenewals: ['Zoe Martinez', 'Janell Cruz', 'Karim Vasquez', 'Brianna Ramirez', 'Javier Lopez', 'Maximiliano Gonzalez', 'Michael Gonza'] },
  { invoiceId: 'inv:0-ChBMhCueCIThav0cbt_OhdfvEJ8I', invoiceNumber: '4300', purchaserName: 'Alonzo Hernandez', purchaserEmail: 'alonzo.hernandez@psjaisd.us', players: [ { name: 'Luciano Flores', uscfId: '3209070' }, { name: 'ricardo vela', uscfId: '30298695' }, { name: 'Devin Flores', uscfId: '30858424' }, { name: 'Anthony Sanchez', uscfId: '31489306' }, { name: 'Jake Lopez', uscfId: '31489536' }, { name: 'Eli Ramos', uscfId: '31679022' }, { name: 'Jose Nicanor', uscfId: '32115244' }, { name: 'Joaquin Rodriguez', uscfId: 'New' }, { name: 'Amen Torres', uscfId: 'New' } ], uscfRenewals: ['Devin Flores', 'Eli Ramos', 'Joaquin Rodriguez', 'Amen Torres'] },
  { invoiceId: 'inv:0-ChDQLHUvzOpAoD3bsGx7FqR9EJ8I', invoiceNumber: '4299', purchaserName: 'Rafael Chico', purchaserEmail: 'rafael.rodriguez@psjaisd.us', players: [ { name: 'Edward Trevino', uscfId: '16469688' }, { name: 'Benjamin Carpio', uscfId: '16800852' }, { name: 'LIam Chapa', uscfId: '30347273' }, { name: 'Derek Tarango', uscfId: '30769889' }, { name: 'Hezekiah Perez', uscfId: '31497168' }, { name: 'Liam Perez', uscfId: '32063717' }, { name: 'Josiah Hernandez', uscfId: '32114967' }, { name: 'Autumn Garza', uscfId: '32115788' }, { name: 'Luke Nava', uscfId: 'New' } ], uscfRenewals: ['Hezekiah Perez', 'Luke Nava'] },
  { invoiceId: 'inv:0-ChAx46Cd3v8CDBwV5WipTYoxEJ8I', invoiceNumber: '4298', purchaserName: 'Oscar Quintanilla', purchaserEmail: 'oscar.quintanilla@psjaisd.us', players: [ { name: 'Athena Munoz', uscfId: '122025' }, { name: 'Ricardo Castillo', uscfId: '3148913' }, { name: 'Cesario Aranda', uscfId: '31489122' }, { name: 'Javier Montes', uscfId: '31489160' }, { name: 'Jax Leal', uscfId: '31489171' }, { name: 'Daniel Tevino', uscfId: '32042219' }, { name: 'Zendrix Oviedo', uscfId: '32049200' }, { name: 'Flavia Tavera', uscfId: 'New' }, { name: 'Alijah Vega', uscfId: 'New' }, { name: 'Jermaine Guzman', uscfId: 'New' } ], uscfRenewals: ['Flavia Tavera', 'Alijah Vega', 'Jermaine Guzman'] },
  { invoiceId: 'inv:0-ChBNzNLwVIafEnQHyBW6urc6EJ8I', invoiceNumber: '4297', purchaserName: 'Moises Diaz', purchaserEmail: 'moises.diaz@psjaisd.us', players: [ { name: 'Carlos Martinez', uscfId: '16112301' }, { name: 'Aiden Cantu', uscfId: '16112426' }, { name: 'Alan Alaniz', uscfId: '16473088' }, { name: 'Kaleb Martinez', uscfId: '17207981' }, { name: 'Rogelio Martinez', uscfId: '31490089' }, { name: 'Jose Cavazos', uscfId: '31499413' }, { name: 'Reynaldo Carranza', uscfId: '31499459' }, { name: 'Alexa Martinez - Valdvia', uscfId: '31606813' }, { name: 'Timothy Perez', uscfId: '32046572' }, { name: 'Esmeralda Torres', uscfId: '32115836' }, { name: 'Aliyah Cantu', uscfId: '32115845' }, { name: 'Dwayne Lozano', uscfId: '158652994' }, { name: 'Noah Hinojosa', uscfId: 'NEW' } ], uscfRenewals: ['Reynaldo Carranza', 'Alexa Martinez - Valdvia', 'Noah Hinojosa'] },
  ...
  { invoiceId: 'inv:0-ChA-some_unique_id_for_4318', invoiceNumber: '4318', purchaserName: 'Maria Sheila Sinapuelas', purchaserEmail: 'maria.sinapuelas@psjaisd.us', players: [ { name: 'Natalie Lopez', uscfId: '32256928' }, { name: 'Joshua Martinez', uscfId: '30367625' } ], uscfRenewals: [] },
];
