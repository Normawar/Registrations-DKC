...
const correctedInvoices = [
  ...
  { invoiceId: 'inv:0-ChBaPl56VbrMq6-fQWViXjt_EJ8I', invoiceNumber: '4303', purchaserEmail: 'sebastian.tijerina@psjaisd.us', schoolName: 'AIDA C ESCOBAR EL', players: [ { name: 'Sebastian Garcia', uscfId: 'NEW' }, { name: 'Landon Garza', uscfId: '31489035' }, { name: 'Jonathan Landero', uscfId: '31489051' }, { name: 'Claudio Ovalle', uscfId: '31489062' }, { name: 'Luciana Torres', uscfId: '31489095' }, { name: 'Roy Gonzalez', uscfId: '31499271' }, { name: 'Emari Salinas', uscfId: 'NEW' }, { name: 'Daniel Diaz', uscfId: 'NEW' }, { name: 'Jaxson Tate', uscfId: 'NEW' }, { name: 'Lilian Cruz', uscfId: 'NEW' }, { name: 'Jayden Luther', uscfId: 'NEW' }, { name: 'Camila Espinoza', uscfId: 'NEW' }, { name: 'Jonathon Monroy', uscfId: 'NEW' }, { name: 'Matias Izaguirre', uscfId: 'NEW' }, { name: 'Matias Izaguirre', uscfId: 'NEW' }, { name: 'Luna Rodeiguez', uscfId: 'NEW' }, { name: 'Erik Martinez', uscfId: 'NEW' }, { name: 'Landon Arriaga', uscfId: 'NEW' }, { name: 'Gabriela Vazquez', uscfId: 'NEW' }, { name: 'Ian Madera', uscfId: 'NEW' }, { name: 'Iker Cruz', uscfId: 'NEW' } ], uscfRenewals: ['Sebastian Garcia', 'Landon Garza', 'Jonathan Landero', 'Claudio Ovalle', 'Luciana Torres', 'Roy Gonzalez', 'Emari Salinas', 'Daniel Diaz', 'Jaxson Tate', 'Lilian Cruz', 'Jayden Luther', 'Camila Espinoza', 'Jonathon Monroy', 'Matias Izaguirre', 'Matias Izaguirre', 'Luna Rodeiguez', 'Erik Martinez', 'Landon Arriaga', 'Gabriela Vazquez', 'Ian Madera', 'Iker Cruz'] },
  { invoiceId: 'inv:0-ChAFLjzZWmImp8hjFZN77oS-EJ8I', invoiceNumber: '4302', purchaserEmail: 'guadalupe.elizondo2@psjaisd.us', schoolName: 'GERALDINE PALMER EL', players: [ { name: 'Matthew Trevino', uscfId: 'New' }, { name: 'Liam Salinas', uscfId: 'New' }, { name: 'Briana Garcia', uscfId: 'New' }, { name: 'Devin Garcia', uscfId: 'New' }, { name: 'Mateo Soto', uscfId: 'New' }, { name: 'Sofia Lee Reyes', uscfId: 'New' }, { name: 'Leonardo Martinez', uscfId: 'New' }, { name: 'Michael Trevino', uscfId: 'New' } ], uscfRenewals: ['Matthew Trevino', 'Liam Salinas', 'Briana Garcia', 'Devin Garcia', 'Mateo Soto', 'Sofia Lee Reyes', 'Leonardo Martinez', 'Michael Trevino'] },
