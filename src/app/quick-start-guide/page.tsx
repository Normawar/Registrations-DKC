...
export default function QuickStartGuidePage() {
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      const convertImage = async (img: HTMLImageElement | null, name: string): Promise<string | null> => {
        if (!img) return null;
        ...
        try {
          ...
          if (error instanceof Error) {
            ...
            console.log(`Failed to convert ${name}:`, error);
          }
        }
        return null;
      };
      ...
      if (error instanceof Error) {
        ...
        console.error("Failed to generate PDF:", error);
        alert(`Sorry, there was an error generating the PDF: An unknown error occurred.`);
      }
    } finally {
                ...
                <CardContent>
                  <div className="space-y-4 text-muted-foreground">
                    ...
                    <ul className="list-disc list-inside space-y-2">
                      <li><strong>Online (Credit Card):</strong> In the invoice details, click <strong>View Invoice on Square</strong> to pay securely online. Payments are automatically marked as "Paid".</li>
