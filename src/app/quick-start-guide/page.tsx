          ...
          <AccordionItem value="item-1">
            <AccordionTrigger>
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-semibold">Step 1: Managing Your Roster</h3>
              </div>
            </AccordionTrigger>
            <AccordionContent className="space-y-4 pt-4">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <p>1. Navigate to the <strong>Roster</strong> page from the sidebar. You will see your team information and an empty roster list.</p>
                  <div className="flex justify-center p-2 border rounded-md">
                    <GuideImage src="https://firebasestorage.googleapis.com/v0/b/chessmate-w17oa.firebasestorage.app/o/App-Images%2F1h.png?alt=media&token=d5caad84-adad-41e3-aa27-ce735ab3c6fd" alt="Team Roster page screenshot" width={700} height={400} className="rounded-md" />
                  </div>
                  <p>2. Click the <strong>Add from Database</strong> button to search for existing players or <strong>Create New Player</strong> to add a student who is not in the system.</p>
                  <p>3. When searching, use the filters to find players by name, USCF ID, school, or district.</p>
                  <p>4. Once you find your student, click <strong>Select</strong>. You will be prompted to fill in any missing required information (like Grade or Section). The player will then be added to your school's roster.</p>
                </CardContent>
              </Card>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger>
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-semibold">Step 2: Registering for an Event</h3>
              </div>
            </AccordionTrigger>
            <AccordionContent className="space-y-4 pt-4">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                    <p>1. Go to the <strong>Dashboard</strong> or <strong>Register for Event</strong> page.</p>
                    <p>2. Find an upcoming event and click the <strong>Register Students</strong> button.</p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <GuideImage src="https://firebasestorage.googleapis.com/v0/b/chessmate-w17oa.firebasestorage.app/o/App-Images%2F1k.png?alt=media&token=c19a9a14-432d-45a4-8451-872f9b8c381c" alt="Event registration page screenshot" width={700} height={500} className="rounded-md border"/>
                        <GuideImage src="https://firebasestorage.googleapis.com/v0/b/chessmate-w17oa.firebasestorage.app/o/App-Images%2F1L.png?alt=media&token=1d074a8e-9c30-4327-9e1e-483a30988f56" alt="Registration dialog screenshot" width={700} height={500} className="rounded-md border"/>
                    </div>
                    <p>3. A dialog will appear listing all players on your roster. Select the players you wish to register for this event.</p>
                    <p>4. For each selected player, confirm their <strong>Section</strong> and <strong>USCF Status</strong> (e.g., if they need a new membership or a renewal).</p>
                    <p>5. Click <strong>Review Charges</strong> to see a full breakdown of fees.</p>
                    <p>6. Finally, click <strong>Register Now</strong>. This will generate an official invoice and complete the registration.</p>
                </CardContent>
              </Card>
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-3">
            <AccordionTrigger>
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-semibold">Step 3: Handling Invoices</h3>
              </div>
            </AccordionTrigger>
            <AccordionContent className="space-y-4 pt-4">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <p>1. Navigate to the <strong>Invoices & Payments</strong> page from the sidebar.</p>
                  <p>2. Here you will see a list of all your invoices and their current status (e.g., Paid, Unpaid, Canceled).</p>
                  <p>3. Click <strong>Details</strong> to view a specific invoice. From here, you can see the registered players and submit payment information.</p>
                  <p>4. For payment, you can either click the <strong>View Invoice on Square</strong> button to pay directly with a credit card, or use an offline method like PO, Check, CashApp, or Zelle.</p>
                  <p>5. If paying offline, select the payment method, fill in the details (like PO or check number), upload proof of payment, and click <strong>Submit Payment Information</strong> for an organizer to review.</p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <GuideImage src="https://firebasestorage.googleapis.com/v0/b/chessmate-w17oa.firebasestorage.app/o/App-Images%2F1p.png?alt=media&token=7a9e0a18-3a9d-42a5-9bb0-e3f873815d16" alt="Invoice details screenshot" width={700} height={500} className="rounded-md border"/>
                      <GuideImage src="https://firebasestorage.googleapis.com/v0/b/chessmate-w17oa.firebasestorage.app/o/App-Images%2F1q.png?alt=media&token=358d7596-a152-4980-89fb-152eaac99f39" alt="Invoice payment options screenshot" width={700} height={500} className="rounded-md border"/>
                  </div>
                </CardContent>
              </Card>
            </AccordionContent>
          ...
          <AccordionItem value="item-4">
            <AccordionTrigger>
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-lg font-semibold">Step 4: Need More Help?</h3>
              </div>
            </AccordionTrigger>
            <AccordionContent className="space-y-4 pt-4">
              <p>For more detailed instructions on every feature, please visit our new <Link href="/help" className="font-semibold text-primary underline">Help Center</Link>.</p>
              <Card>
                <CardHeader>
