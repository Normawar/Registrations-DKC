...
export default function QuickStartGuidePage() {
  ...
  try {
    ...
    const convertImage = async (img, name) => {
      if (!img) return null;
    ...
    console.log('Section 1 using roster image:', rosterData ? 'Data URL' : 'Placeholder');
